...
def selecionador():
    lista_falhou = ['Não foi dessa vez, tente denovo, eu sei que você consegue!','Essa era díficil mesmo, mas continue tentando.','Essa foi por pouco, que tal tentar denovo.']
    lista_palavras = ['roxo','preto','branco','cinza','amarelo','verde','vermelho','ciano','marrom','laranja']
